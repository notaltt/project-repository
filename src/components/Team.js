            ...
            <aside className='z-20 hidden w-64 overflow-y-auto bg-white dark:bg-sky-100   md:block flex-shrink-0' >
                ...
                <div className='py-4 text-black dark:text-black'>
                    ...
                    <ul class="mt-6">
                        ...
                        <a className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-blue-400" href="/dashboard">
                    ...
                    <ul>
                        ...
                        <a className="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-blue-800 dark:hover:text-blue-200 dark:text-blue-400" href="/team">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
